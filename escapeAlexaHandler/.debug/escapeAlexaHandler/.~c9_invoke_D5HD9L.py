...
def build_room_description(name, edges, items, interactables):
    ...
    if not available_items:
        ...
        #make this more grammatically correct/flexible later
        items_sentence = "In this room there is a " + ", a ".join(available_items) + " that may be added to your inventory at this time."
    
    if not interactables:
        interactables_sentence = "In terms of interactable objects, there are none."
    else:
        interactables_sentence = "In terms of interactable objects, there is a " + ", a ".join(interactables) + "."
...
myRoom = Room("room", ["room2"], [Item("item", "an item", False)], [Interactable("interactable", "an interactable", True, [], ["item"])], True, [])
secondRoom =  Room("room2", ["room", "endRoom"], [Item("item2", "another item", True)], [Interactable("interactable2", "another interactable", True, [], [])], True, [])
endRoom = Room("endRoom", ["room2"], [Item("item3", "another item", True)], [Interactable("interactable2", "another interactable", True, [], [])], False, ["item"])
...
def first_room_dialogue(intent, session):
    ...
    should_end_session = False
    #
    speech_output = "You have entered, " + session['attributes']['curRoom'].name + \
...
def interact_with(intent, session):
